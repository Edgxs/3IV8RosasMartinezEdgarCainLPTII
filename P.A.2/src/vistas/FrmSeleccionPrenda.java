 ...
 * @author edgar
 */
public class FrmSeleccionPrenda extends javax.swing.JFrame {

    /**
     * Creates new form SeleccionPrenda
     */
    public FrmSeleccionPrenda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jCbPantalon, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 210, 180));

        jCbPlayera.setContentAreaFilled(false);
        jPanel2.add(jCbPlayera, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, 210, 180));

        jCbCamisa.setContentAreaFilled(false);
        jPanel2.add(jCbCamisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 130, 210, 180));

        jCbSudadera.setContentAreaFilled(false);
        jPanel2.add(jCbSudadera, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 370, 210, 180));

        jCbSueter.setContentAreaFilled(false);
        jPanel2.add(jCbSueter, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 370, 210, 180));

        JLboxPrenda1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesUser/boxPantalon.png"))); // NOI18N
        jPanel2.add(JLboxPrenda1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, -1, -1));

        JLboxPrenda2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesUser/boxPlayera.png"))); // NOI18N
        jPanel2.add(JLboxPrenda2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, -1, -1));

        JLboxPrenda3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesUser/boxCamisa.png"))); // NOI18N
        jPanel2.add(JLboxPrenda3, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 130, -1, -1));

        JLboxPrenda4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesUser/boxSudadera.png"))); // NOI18N
        jPanel2.add(JLboxPrenda4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 370, -1, -1));

        JLboxPrenda5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesUser/boxSueter.png"))); // NOI18N
        jPanel2.add(JLboxPrenda5, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 370, -1, -1));

        jLabel13.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel13.setText("Sueter");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 560, -1, -1));

        jLabel8.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel8.setText("Sudadera");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 560, -1, -1));

        jLabel4.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel4.setText("Playera");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 320, -1, -1));

        jLabel7.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel7.setText("Camisa");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 320, -1, -1));

        jLabel14.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel14.setText("Pantalon");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, -1, -1));
        ...
        jLabel5.setText(" que consideras para hacer el calculo");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, -1, -1));

        jLabel6.setBackground(new java.awt.Color(0, 176, 240));
        jLabel6.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 28)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 176, 240));
        jLabel6.setText("Por favor selecciona el tipo de prenda(s)");
        ...
        jPanel2.add(jBtnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 540, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSeleccionPrenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSeleccionPrenda().setVisible(true);
            }
        });
    }
