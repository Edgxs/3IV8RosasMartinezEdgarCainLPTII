                ...
                if (JcbGenero.getSelectedItem().toString().equals("Genero")) {
                    ...
                    if (JcbAlcaldia.getSelectedItem().toString().equals("Alcaldia")) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(this, txt_user.getText()+ txt_nombre.getText()+ txt_pass.getText()+ JcbGenero.getSelectedItem().toString()+ JcbAlcaldia.getSelectedItem().toString());
                            try {
